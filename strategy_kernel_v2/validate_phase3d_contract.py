...
def validate():
    ...
    if not s["phase3d_started"] or not s["phase3d_evaluation_contract_frozen"] or s["phase3d_outcomes_loaded"]: errors.append("PROGRAM_STATE_PHASE3D_FREEZE_MISMATCH")
    if cur["validation"]["phase3d_outcomes_loaded"]: errors.append("CURRENT_STATUS_OUTCOMES_PRELOADED")
...
if __name__ == "__main__":
    ...
    print("PHASE3D_CONTRACT_FREEZE_PASS horizons=1,3,5 outcomes_loaded=false orders=0 trade_authority=NONE")
