...
DOMAIN_STALE_DAYS = {
    ...
    "FINANCIAL_VALUATION_CONTEXT": 7,
    "FINANCIAL_STATEMENT_CONTEXT": 120,
    "US_BOUNDED_COVERAGE": 5,
    "SEC_QUEUE_CONSUMER": 10,
    "SEC_OFFICIAL_RETRIEVAL": 10,
    "PORTFOLIO_DECISION_FRESHNESS": 5,
    "PORTFOLIO_PRODUCT_SURFACE": 5,
    "DECISION_LIFECYCLE": 5,
    "PORTFOLIO_EXECUTION_SIMULATION": 5,
}
