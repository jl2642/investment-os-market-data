...
The validation pull request exists only to expose the GitHub-hosted execution result; it does not relax any acceptance gate. Failed runs retain a seven-day diagnostic artifact for exact remediation.
