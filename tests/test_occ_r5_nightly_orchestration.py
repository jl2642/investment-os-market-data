...
def test_final_runtime_uses_clock_wakeups_for_data_and_event_driven_investment_chain() -> None:
    expected_clock_wakeups = {
        ".github/workflows/fmdl-daily-production.yml": 'cron: "30 9 * * 1-5"',        # 17:30 CN market chain
        ".github/workflows/wp2_r_market_marks_refresh.yml": 'cron: "45 14 * * 1-5"',  # 22:45 CN marks
        ".github/workflows/fmdl-2b4-full-rebase.yml": 'cron: "0 8 * * 1-5"',           # 16:00 CN recovery
        ".github/workflows/round3-cross-market-limited-production.yml": 'cron: "30 21 * * 1-5"', # 05:30 CN supporting market research
    }
