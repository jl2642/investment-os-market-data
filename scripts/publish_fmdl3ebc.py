...
def main() -> int:
    ...
    release = {
        ...
        "acceptance_mode": metrics.get("market_acceptance_mode", decision.get("mode")),
        ...
        "baseline_id": metrics["baseline_id"],
        "source_fmdl3d_release_id": metrics["source_fmdl3d_release_id"],
        "baseline_market_as_of_date": metrics["baseline_market_as_of_date"],
        "refreshed_market_as_of_date": metrics["refreshed_market_as_of_date"],
        "market_replay_from_date": metrics.get("market_replay_from_date"),
        "market_replay_to_date": metrics.get("market_replay_to_date"),
        "post_frozen_baseline_advance_observed": metrics.get("post_frozen_baseline_advance_observed", True),
    ...
    pointer = {
        ...
        "market_status": decision["market_status"],
        "financial_status": decision["financial_status"],
        "acceptance_mode": release["acceptance_mode"],
