...
def main() -> int:
    ...
    pointer = {
        ...
        "financial_statement_release_id": decision["financial_denominator"].get("statement_release_id"),
        "financial_factor_release_id": decision["financial_denominator"].get("financial_factor_release_id"),
        "financial_score_release_id": decision["financial_denominator"].get("financial_score_release_id"),
        "financial_event_propagation": decision["financial_denominator"]["financial_event_propagation"],
        "exact_baseline": decision.get("exact_baseline"),
